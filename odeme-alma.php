...
$kullanici_adi =  $_SESSION['giris_tamam'];
...
if  ($sorgusayisi > 0) {
    ...
    $kisibilgileri = $sorgu->fetch(PDO::FETCH_ASSOC);
    
    $kullanici_email = $kisibilgileri['email'];
    $odenecek_tutar = 200;
    $siparis_id = "11". rand(1,999). rand(1,88). rand(1,50) ;
    $kullanici_adres = "Niğde Merkez";
    $kullanici_telefon = "+90 552 637 05 51";
} else {
    echo "Ödemede bir sorun oluştu lütfen tekrardan giriş yapınız ve kontrol ediniz !!";
}
...
<div style="width: 100%;margin: 0 auto;display: table;">
	...
	$payment_amount	= $odenecek_tutar * 100; //9.99 için 9.99 * 100 = 999 gönderilmelidir.
	#
	...
	$user_address = $kullanici_adres;
	#
	## Müşterinizin sitenizde kayıtlı veya form aracılığıyla aldığınız telefon bilgisi
	$user_phone = $kullanici_telefon;
	#
